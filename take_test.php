                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">Okul yılı: <?php echo $class_row['school_year']; ?></a> <span class="divider">/</span></li>
							<li><a href="#"><b>Uygulama Quiz</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
...
?>
										<h3>Test Başlığı: <b><?php echo $rowa['quiz_title'];?></b></h3>
										<p><b>Açıklama:<?php echo $rowa['quiz_description'];?></b></p>
										<p></p>
...
?>
<br/>
<button onclick="return false;" qn="<?php echo $x;?>" class="nextq btn btn-success" id="next_<?php echo $x;?>">SONRAKİ SORU <i class="icon-arrow-right"></i> </button>
...
<td></td>
<td>
<button class="btn btn-info" id="submit-test" name="submit_answer"><i class="icon-check"></i> Cevabı gönder</button>
...
<?php
	...
	<a href="student_quiz_list.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left"></i> geri</a>
	<center>
	<h3><br>puanın <b><?php echo $score; ?></b> dışında <b><?php echo ($x-1); ?></b><br/></h3>
	</center>
	<?php
	/* echo "Your Percentage Grade is : <b>".$per."%</b>"; */
	mysql_query("UPDATE student_class_quiz SET `student_quiz_time` = 3600, `grade` = '".$score." dışında ".($x-1)."' WHERE student_id = '$session_id' and class_quiz_id = '$class_quiz_id'")or die(mysql_error());
?>
<script>
