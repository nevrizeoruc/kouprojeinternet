   ...
   <meta http-equiv="Content-Type" content="text/HTML; charset=utf-8" />
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">ekle kullanıcı</div>
                            </div>
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="username" id="focusedInput" type="text" placeholder = "Kullanıcı Adı" required>
                                          </div>
                                        </div>
...
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$user_username','ekle kullanıcı $username')")or die(mysql_error());
?>
<script>
