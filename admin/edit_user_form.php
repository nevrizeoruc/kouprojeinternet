   ...
   <a href="admin_user.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> ekle user</a>
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">düzenle kullanıcı</div>
                            </div>
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['username']; ?>"  name="username" id="focusedInput" type="text" placeholder = "Kullanıcı Adı" required>
                                          </div>
                                        </div>
...
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$user_username','düzenle kullanıcı $username')")or die(mysql_error());
?>
<script>
