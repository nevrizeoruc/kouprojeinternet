<meta http-equiv="Content-Type" content="text/HTML; charset=utf-8" />
			<form id="signin_teacher" class="form-signin" method="post">
					<h3 class="form-signin-heading"><i class="icon-lock"></i> Öğretmen Olarak kaydolun</h3>
					...
					<button id="signin" name="login" class="btn btn-info" type="submit"><i class="icon-check icon-large"></i> kaydol</button>
			</form>
			<script>
			...
			<a onclick="window.location='index.php'" id="btn_login" name="login" class="btn" type="submit"><i class="icon-signin icon-large"></i> giriş yap</a>
