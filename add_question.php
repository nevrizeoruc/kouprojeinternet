                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										<li><a href="#"><b>Quiz sorusu</b></a></li>
									</ul>
						 <!-- end breadcrumb -->
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="quiz_question.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> geri</a>
								</div>
                            </div>
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
								        <div class="control-group">
											<label class="control-label" for="inputPassword">soru</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">soru tipi:</label>
											<div class="controls">			
						...
						<div class="control-group">
										...
										<button name="save" type="submit" class="btn btn-info"><i class="icon-save"></i> kayıt</button>
										</div>
										</div>		
