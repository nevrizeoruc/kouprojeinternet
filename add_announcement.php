<head>
<meta http-equiv="içerik-Type" content="text/html; charset=utf-8" />
</head>
...
<?php include('session.php'); ?>
    <body id="class_div">
        ...
        <div class="container-fluid">
                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								?>
								<li><a href="#"><b>Sınıflarım</b></a><span class="divider">/</span></li>
			...
			<div class="alert alert-info">Bu dosyayı koymak istediğiniz Sınıf'ı kontrol edin.</div>
						...
						<?php } ?>
								...
								<hr>
									...
									<div class="control-group">
												<div class="controls">
													<button name="Yükleme" type="submit" value="Yükleme" class="btn btn-success" /><i class="icon-check"></i>&nbsp;Post</button>
												</div>
									</div>
									</center>
