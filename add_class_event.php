...
<form id="signin_student" class="form-signin" method="post">
	<h4 class="form-signin-heading"><i class="icon-plus-sign"></i> olay ekle</h4>
	    <input type="text" class="input-block-level datepicker" name="date_start" id="date01" placeholder="tarih Start" required/>
	    <input type="text" class="input-block-level datepicker" name="date_end" id="date01" placeholder="tarih End" required/>
		<input type="text" class="input-block-level" id="username" name="title" placeholder="başlık" required/>
	<button id="signin" name="add" class="btn btn-info" type="submit"><i class="icon-save"></i> kayıt</button>
</form>
<?php
if (isset($_POST['add'])){
