            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						...
						?>
							<li><a href="#"><b>Bildirimler</b></a><span class="divider">/</span></li>
							<li><a href="#">Mesejlar: <?php echo $school_year_query_row['school_year']; ?></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<?php }}else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> Şuanda Sınıfıza Kayıtlı Deyilsiniz Yönetici Onayı Beklemekte</div>
									<?php } ?>	
									</ul>
