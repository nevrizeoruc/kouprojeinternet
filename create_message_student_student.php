				      ...
				      <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-pencil"></i> Create Mesaj</h4></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								    ...
								    <ul class="nav nav-tabs">
										...
										<li class="active"><a href="student_message_student.php">For öğrenci</a></li>
												...
												<script>
															...
															jQuery("#send_message_student").submit(function(e){
																	...
																	$.ajax({
																		...
																		$.jGrowl("Mesaj Successfully Sended", { header: 'Mesaj Sent' });
																		var delay = 2000;
