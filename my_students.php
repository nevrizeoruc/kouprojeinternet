                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						<div class="pull-right">
							<a href="add_student.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-plus-sign"></i> ekle öğrenci</a>
							<a onclick="window.open('print_student.php<?php echo '?id='.$get_id; ?>')"  class="btn btn-success"><i class="icon-list"></i> öğrenci List</a>
						</div>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								Number of öğrenciler: <span class="badge badge-info"><?php echo $count_my_student; ?></span>
								</div>
                            </div>
                                ...
                                <div class="span12">
									<ul	 id="da-thumbs" class="da-thumbs">
											...
											<li id="del<?php echo $id; ?>">
													...
													<a  href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Kaldır</a>	
											</li>
													...
													$(document).ready( function() {
														...
														var id = $(this).attr("id");
															...
															success: function(html){
																...
																$('#'+id).modal('hide');
																$.jGrowl("Your öğrenci is Successfully Kaldır", { header: 'öğrenci Kaldır' });
															}
															}); 	
															return false;
														});				
