								...
								?>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td width="30">
										 <a  data-placement="bottom" title="indir" id="<?php echo $id; ?>indir" href="<?php echo $row['floc']; ?>"><i class="icon-download icon-large"></i></a>
										 </td>            
														<script type="text/javascript">
														$(document).ready(function(){
															$('#<?php echo $id; ?>indir').tooltip('show');
															$('#<?php echo $id; ?>indir').tooltip('hide');
														});
														</script>										 
                                </tr>
