        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="pull-right">
							<a href="my_students.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> geri</a>
						</div>
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">öğrenciler</a><span class="divider">/</span></li>
							<li><a href="#"><b>öğrenci ekle</b></a></li>
						</ul>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<form method="post" action="">
										...
										<button name="submit" type="submit" class="btn btn-info"><i class="icon-save"></i>&nbsp;öğrenci ekle</button>
												<br>
												<br>
...
if (isset($_POST['submit'])){
	...
	$count = mysql_num_rows($query); 
 	...
 	if ($count > 0){ ?>
	<script>
	 alert('öğrenci Already in the class'); 
	</script>
	<script>
