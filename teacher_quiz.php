                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="add_quiz.php" class="btn btn-info"><i class="icon-plus-sign"></i> quiz ekle</a>
									<td width="30"><a href="add_quiz_to_class.php" class="btn btn-success"><i class="icon-plus-sign"></i> sınıfa quiz ekle</a></td>   
									</div>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td><a href="quiz_question.php<?php echo '?id='.$id; ?>">soru</a></td>                                      
