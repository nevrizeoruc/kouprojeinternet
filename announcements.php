					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<br>
								<button name="post" class="btn btn-info"><i class="icon-check icon-large"></i> gönder</button>
								</form>
                                </div>
								...
								<?php
									...
									mysql_query("insert into notification (teacher_class_id,notification,date_of_notification,link) value('$get_id','ekle Annoucements',NOW(),'announcements_student.php')")or die(mysql_error());
									?>
									<script>
