                     ...
                     <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Yüklenen Ödevler</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									$count = mysql_num_rows($query);
									if ($count == '0'){?>
									<div class="alert alert-info">Şu anda Yüklenen Atama Yok</div>
									<?php
									}else{
								?>
									...
									?>                              
										...
										<?php } ?>
										 <button  data-placement="bottom" title="Submit ödev" id="<?php echo $id; ?>submit" class="btn btn-success" name="btn_assign"><i class="icon-upload icon-large"></i> Ödev Teslim Edin</button>
										 </form>
										 </td>                                      
