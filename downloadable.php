...
<meta http-equiv="Content-Type" content="text/HTML; charset=utf-8" />
                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>İndirilebilir Malzemeler</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
							...
							Hepsini Kontrol Edin <input type="checkbox"  name="selectAll" id="checkAll" />
								<script>
  								...
  								<form action="copy_file.php" method="post">
									...
									?>                              
										<tr id="del<?php echo $id; ?>">
                                         ...
                                         <td width="40">
										 <a  data-placement="bottom" title="indir" id="<?php echo $id; ?>download" href="<?php echo $row['floc']; ?>"><i class="icon-download icon-large"></i></a>
										 <a  data-placement="bottom" title="Kaldır" id="<?php echo $id; ?>remove" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-remove icon-large"></i></a>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			$('#'+id).modal('hide');
			$.jGrowl("Your Post is Successfully Deleted", { header: 'Data sil' });
